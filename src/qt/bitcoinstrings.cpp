...
QT_TRANSLATE_NOOP("bitcoin-core", "Copyright (C) 2009-%i The _REBRAND_TRANSLATION_SOFTWARE_NAME_ Developers"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Error loading wallet.dat: Wallet requires newer version of _REBRAND_TRANSLATION_SOFTWARE_NAME_"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Initialization sanity check failed. _REBRAND_TRANSLATION_SOFTWARE_NAME_ is shutting down."),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Wallet needed to be rewritten: restart _REBRAND_TRANSLATION_SOFTWARE_NAME_ to complete"),
